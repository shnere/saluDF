 ...
 */
;(function($, undefined) {
  $.fn.drawDoughnutChartMortalidad = function(data, options) {
    var $this = this,
      W = $this.width(),
      H = $this.height(),
      centerX = W/2,
      ...
      settings = $.extend({
        ...
        onPathEnter : function(e,data) { 
				...
				showClass = function(val){ 
					var keys = ["septicemia", "nefritis", "acidosis", "isquemica", "cerebrovascular", "neumonia", "choque-hipovolemico", "insuficiencia-renal", "peritonitis", "sepsis-bacteriana"];
